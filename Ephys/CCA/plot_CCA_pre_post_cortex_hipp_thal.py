...
sns.lineplot(x='time', y='value', data=cca_long_df[cca_long_df['variable'] == 'post_cca_bl'],
             hue='region_pair', ax=ax2, ci=68, hue_order=['PPC-Thal', 'Hipp-Thal'],
             palette=[colors['PPC'], colors['Thal']], legend=None)
...
plt.savefig(join(fig_path, 'CCA_pre_post_PPC_Thal_Hipp.pdf'))
...
plt.savefig(join(fig_path, 'CCA_pre_PPC_Thal_Hipp_per_mouse.pdf'))

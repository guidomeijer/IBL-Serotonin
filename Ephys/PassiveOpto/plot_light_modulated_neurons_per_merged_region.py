...
summary_df['perc_mod_all'] =  (summary_df['modulated'] / summary_df['n_neurons']) * 100
summary_df['perc_mod'] =  (summary_df['modulated_late'] / summary_df['n_neurons']) * 100
...
summary_no_df['perc_mod_all'] =  (summary_no_df['modulated'] / summary_no_df['n_neurons']) * 100
summary_no_df['perc_mod'] =  (summary_no_df['modulated_late'] / summary_no_df['n_neurons']) * 100
...
ax1.set(ylabel='', xlabel='Modulated neurons (%)', xlim=[-51, 26],
        xticklabels=np.concatenate((np.arange(50, 0, -25), np.arange(0, 26, 25))))
...
ax2.set(ylabel='', xlabel='Modulated neurons (%)', xlim=[-81, 31],

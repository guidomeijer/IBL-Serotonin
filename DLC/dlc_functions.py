...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 29 10:29:02 2021
By: Michael Schartner & Matt Whiteway
"""
...
def get_dlc_XYs(eid, video_type='left', one=None):
    one = one or ONE()
    Times = one.load_dataset(eid, dataset='_ibl_leftCamera.times.npy')
    cam = pd.read_parquet(join(one.eid2path(eid), 'alf', '_ibl_leftCamera.dlc.pqt'))

...
for i, nickname in enumerate(subjects['subject']):
    ...
    for j, eid in enumerate(eids):
        ...
        for t, trial_start in enumerate(trials['goCue_times']):
            ...
            this_diameter = this_diameter - np.mean(this_diameter[TIME_BINS < 0])
    ...
    if pupil_size.shape[0] > 0:
        ...
        plt.savefig(join(fig_path, f'{nickname}_pupil_opto_blocks'))
...
results_df.to_pickle(join(save_path, 'pupil_opto_blocks.p'))
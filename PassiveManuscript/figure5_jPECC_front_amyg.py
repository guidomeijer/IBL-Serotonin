...
ax1.imshow(np.flipud(np.mean(jPECC['M2-mPFC'], axis=2)), vmin=0.2, vmax=0.6, cmap='inferno',
...
ax2.imshow(np.flipud(np.mean(jPECC['mPFC-Amyg'], axis=2).T), vmin=0.2, vmax=0.6, cmap='inferno',
           extent=[time_ax[0] - np.mean(np.diff(time_ax))/2, time_ax[-1] + np.mean(np.diff(time_ax))/2,
                   time_ax[0] - np.mean(np.diff(time_ax))/2, time_ax[-1] + np.mean(np.diff(time_ax))/2])
ax2.invert_xaxis()
...
ax2.imshow(np.flipud(np.mean(jPECC['ORB-Amyg'], axis=2).T), vmin=0.2, vmax=0.6, cmap='inferno',
           extent=[time_ax[0] - np.mean(np.diff(time_ax))/2, time_ax[-1] + np.mean(np.diff(time_ax))/2,
                   time_ax[0] - np.mean(np.diff(time_ax))/2, time_ax[-1] + np.mean(np.diff(time_ax))/2])
ax2.invert_xaxis()
ax2.plot([0, 0], [-1, 2], color='white')

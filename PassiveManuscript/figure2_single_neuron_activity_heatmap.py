...
f, ((ax_hc, ax_mpfc, ax_ppc, ax_pag, ax_th, ax_am),
    (ax_pir, ax_orb, ax_bc, ax_1, ax_2, ax_3),
    (ax_m2, ax_sc, ax_str, ax_cb, ax_4, ax_5)) = plt.subplots(3, 6, figsize=(7, 3.5), sharex=True, dpi=dpi)
title_font = 7

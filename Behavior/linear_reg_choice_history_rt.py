...
for i, nickname in enumerate(subjects['subject']):
    ...
    for j, eid in enumerate(eids):
        ...
        trials = trials.append(trials, ignore_index=True)
...
plot_df = results_df.groupby(['subject', 'opto']).mean().reset_index()
...
plt.savefig(join(fig_path, 'linear_regression_choice_history'), dpi=300)

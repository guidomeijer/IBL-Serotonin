...
sns.stripplot(x='expression', y='tau', data=results_df[results_df['model'] == 'prev actions'], s=4,
...
sns.stripplot(x='expression', y='tau', data=results_df[results_df['model'] == 'stim side'], s=4,
